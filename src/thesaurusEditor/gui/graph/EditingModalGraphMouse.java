...
public class EditingModalGraphMouse<V,E> extends AbstractModalGraphMouse 
	...
	public EditingModalGraphMouse(RenderContext<V,E> rc,
			Factory<V> vertexFactory, Factory<E> edgeFactory, Main main) {

		this(rc, vertexFactory, edgeFactory, 1.1f, 1/1.1f, main);
	}
	 ...
	 */
	public EditingModalGraphMouse(RenderContext<V,E> rc,
			Factory<V> vertexFactory, Factory<E> edgeFactory, float in, float out, Main main) {
		super(in,out);
		this.main = main;
    ...
    protected void loadPlugins() {
		pickingPlugin = new PickingGraphMousePlugin<V,E>(main);
